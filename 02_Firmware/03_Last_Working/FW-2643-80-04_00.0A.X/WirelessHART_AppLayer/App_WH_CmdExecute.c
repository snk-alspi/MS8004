...
//    else {p_pResponse->m_ucMesStrtStat = 0;}
     ...
     {
         p_pResponse->h_fMat_Thick_Raw = mat_thick_raw;
         p_pResponse->h_fMat_Thick_TC = mat_thick_TC;
         p_pResponse ->h_fMat_Temp = mat_temp ;
         p_pResponse ->h_fDSI_Temp = dsi_t ;
     }
    return RCS_N00_Success;
}
...
//{
//    
////    memcpy(&HRT_Para, &p_pRequest, sizeof(p_pRequest));
//    
////    HRT_Para.h_fCal_0_offset = p_pRequest->h_cal_0_offset;
////    HRT_Para.h_fMaterial_velocity = p_pRequest->h_material_velocity;
////    HRT_Para.h_fA_scan_start = p_pRequest->h_a_scan_start;
////    HRT_Para.h_uiPulsar_width = p_pRequest->h_pulsar_width;
////    HRT_Para.h_uiGain = p_pRequest->h_gain;
////    HRT_Para.h_fG1_start = p_pRequest->h_g1_start;
////    HRT_Para.h_fG1_width = p_pRequest->h_g1_width;
////    HRT_Para.h_fG1_thershold = p_pRequest->h_g1_thershold;
////    HRT_Para.h_fG2_start = p_pRequest->h_g2_start;
////    HRT_Para.h_fG2_width = p_pRequest->h_g2_width;
////    HRT_Para.h_fG2_thershold = p_pRequest->h_g2_thershold;
////    HRT_Para.h_uiMeasurement_mode = p_pRequest->h_measurement_mode;
//    
////    MRes = strt_measurement(2);
//    
////      memcpy(&p_pResponse, &HRT_Para, sizeof(HRT_Para)-8);
//    
////    p_pResponse->h_cal_0_offset = HRT_Para.h_fCal_0_offset;
////    p_pResponse->h_material_velocity = HRT_Para.h_fMaterial_velocity; 
////    p_pResponse->h_a_scan_start = HRT_Para.h_fA_scan_start;
