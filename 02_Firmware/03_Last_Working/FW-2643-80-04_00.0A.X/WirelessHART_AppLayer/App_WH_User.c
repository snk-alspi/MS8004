...
uint8 ucCodeIndex = 0;
    ...
    */
    ...
    {
        case DEVICE_VARIABLE_0:
            g_stProv.m_astDeviceVarsValues[DEVICE_VARIABLE_0].m_stValue.m_fValue = mat_thick_raw;  //(g_stDataToPublish.fpValue);
            break;
        case DEVICE_VARIABLE_1:
            g_stProv.m_astDeviceVarsValues[DEVICE_VARIABLE_1].m_stValue.m_fValue = mat_thick_TC; //g_stDeviceProcessVariables.m_unMeasurementTimeInterval;
            break;
        case DEVICE_VARIABLE_2:  // should be converted to %
            g_stProv.m_astDeviceVarsValues[DEVICE_VARIABLE_2].m_stValue.m_fValue = mat_temp; 
            break;
        case DEVICE_VARIABLE_3:
             g_stProv.m_astDeviceVarsValues[DEVICE_VARIABLE_3].m_stValue.m_fValue = ((float)(EnergyLeftDays/1825)*100);  
            break;
        case DEVICE_VARIABLE_4:
            g_stProv.m_astDeviceVarsValues[DEVICE_VARIABLE_4].m_stValue.m_fValue = dsi_t; //EnergyLeftDays;
            break;
        case DEVICE_VARIABLE_5:
