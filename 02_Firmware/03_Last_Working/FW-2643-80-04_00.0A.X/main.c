...
* 
* Project Name     : MS8000 MULTI CHANNEL(4CHANNELS) UT
* Version          : FW-2463-02.00_A
* Created Date     : 06 NOVEMBER 2023
* Modified date    : 
* Prod, Rel date   : ???????
 ...
 * V00_0A
 * Date : 06 Nov 23
* Started MultiChannel coding
 * Copied from last working MS8000 code
 * 
 */
