...
//{
//    if(c190_stat && g_ucMeasurementInProgress)
//    {
//        return RCS_E34_DelayedResponseRunning;
//    }
//    else if(c191_stat || c193_stat)
//    {
//        return RCS_E36_DelayedResponseConflict;
//    }
//    else if(g_ucMeasurementInProgress || m_ucHartReqInProgress)
...
//             
//    }
//    else if (c190_stat && !g_ucMeasurementInProgress)
//    {
//      c190_stat=0;             
//    }
//    
...
//        return RCS_E16_AccessRestricted;
//    }
//    if(p_ucCmdSize > C191_ReqSize)
//    {
//        return RCS_E05_TooFewDataBytesReceived;
//    }
//    if(c191_stat && m_ucHartReqInProgress)
//    {
//        return RCS_E34_DelayedResponseRunning;
//    }
//    else if(c193_stat || c190_stat)
//    {
//        return RCS_E36_DelayedResponseConflict;
//    }
//    else if(g_ucMeasurementInProgress || m_ucHartReqInProgress)
...
//        
//        
////      memcpy(&HRT_Para, p_pucStream, sizeof(p_pucStream));
////    InverseMemcpy((uint8*)&HRT_Para.h_fCal_0_offset, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&HRT_Para.h_fMaterial_velocity, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&HRT_Para.h_fA_scan_start, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&HRT_Para.h_uiPulsar_width, p_pucStream, 2); p_pucStream += 2;
...
//             
//    }
//    else if (c191_stat && !m_ucHartReqInProgress)
//    {
//      c191_stat=0;             
//    }
////    memcpy(&p_pRequest, &p_pucStream,sizeof(p_pucStream));
//   
//    
//    
//    
////    InverseMemcpy((uint8*)&p_pRequest->h_cal_0_offset, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_material_velocity, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_a_scan_start, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_pulsar_width, p_pucStream, 2); p_pucStream += 2;
////    InverseMemcpy((uint8*)&p_pRequest->h_gain, p_pucStream, 2); p_pucStream += 2;
////    InverseMemcpy((uint8*)&p_pRequest->h_g1_start, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_g1_width, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_g1_thershold, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_g2_start, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_g2_width, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_g2_thershold, p_pucStream, 4); p_pucStream += 4;
////    InverseMemcpy((uint8*)&p_pRequest->h_measurement_mode, p_pucStream, 2); p_pucStream += 2;
////    
////    if(p_pRequest->h_cal_0_offset > 9999 || p_pRequest->h_material_velocity > 100000 ||
////       p_pRequest->h_a_scan_start > 9999 || p_pRequest->h_pulsar_width > 9999 ||
////       p_pRequest->h_gain > 9999 || p_pRequest->h_g1_start > 9999 ||     
////       p_pRequest->h_g1_width > 9999 || p_pRequest->h_g1_thershold > 100.0 ||     
////       p_pRequest->h_g2_start > 9999 || p_pRequest->h_g2_width > 9999 ||     
////       p_pRequest->h_g2_thershold > 100.0   )
////    {
...
////    if(p_pRequest->h_cal_0_offset < 0 || p_pRequest->h_material_velocity < 0 ||
////       p_pRequest->h_a_scan_start < 0 || p_pRequest->h_pulsar_width < -32768 ||
////       p_pRequest->h_gain < -32768 || p_pRequest->h_g1_start < 0 ||     
////       p_pRequest->h_g1_width < 0 || p_pRequest->h_g1_thershold < -100.0 ||     
////       p_pRequest->h_g2_start <0  || p_pRequest->h_g2_width < 0 ||     
////       p_pRequest->h_g2_thershold < -100.0   )
////    {
...
//        return RCS_E32_Busy;
//    }
//     if(p_ucCmdSize > C193_ReqSize)
//    {
//        return RCS_E05_TooFewDataBytesReceived;
//    }
//    if(c193_stat && m_ucHartReqInProgress)
//    {
//        return RCS_E34_DelayedResponseRunning;
//    }
//    else if(c191_stat || c190_stat)
//    {
//        return RCS_E36_DelayedResponseConflict;
//    }
//    else if(g_ucMeasurementInProgress || m_ucHartReqInProgress)
...
//             
//    }
//    else if (c193_stat && !m_ucHartReqInProgress)
//    {
//      c193_stat=0;             
//    }
//        
